...
(11, '2020_10_14_155817_add_google_mail_id_table', 1),
(12, '2020_10_14_160820_create_categories_table', 1),
(13, '2020_10_14_171527_create_sizes_table', 1),
(14, '2020_10_14_173453_create_products_table', 1);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `google_mail_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `google_mail_id`) VALUES
(1, 'Divya Patange', 'divyapatange@gmail.com', NULL, '$2y$10$iF0Cln6l0gN/kg6fyVll/uYx2kX11r/58wNYvN3vyLZiz2lLYT0b.', NULL, '2020-10-14 22:02:34', '2020-10-14 22:02:34', NULL);
COMMIT;
